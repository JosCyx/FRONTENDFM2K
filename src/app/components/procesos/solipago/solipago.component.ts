  ...
  sendMail(mailToNotify: string, type: number) {
    ...
    setTimeout(() => {
      const data = {
        ...
        asunto: 'Nueva Solicitud de Pago Recibida - Acción Requerida',
