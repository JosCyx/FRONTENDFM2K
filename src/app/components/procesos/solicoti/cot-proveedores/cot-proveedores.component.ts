                                ...
                                <tr>
                                  <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                    ...
                                    <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
                                      <p style="margin: 0cm; font-size: 11pt; font-family: Calibri, sans-serif; line-height: 160%; text-align: left;"><strong><span style="font-family: Arial, sans-serif; line-height: 22.4px;">Fecha: </span></strong><span style="font-family: Arial, sans-serif; line-height: 22.4px;"><em>${this.sol_fecha}</em>&nbsp; &nbsp; &nbsp; &nbsp;<strong>Para: </strong><em>${prov.cotProvNombre}</em></span></p>
                                ...
                                <tr>
                                  <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                    ...
                                    <div style="font-size: 14px; font-weight: 700; line-height: 140%; text-align: center; word-wrap: break-word;">
                                      <p style="line-height: 140%;">DESCRIPCIÓN</p>
                                    </div>
                              ...
                              <tbody>
                                <tr>
                                  <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                    ...
                                    <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
                                      <p style="margin: 0cm; font-size: 11pt; font-family: Calibri, sans-serif; line-height: 160%; text-align: left;"><strong><span style="font-family: Arial, sans-serif; line-height: 22.4px;">Fecha: </span></strong><span style="font-family: Arial, sans-serif; line-height: 22.4px;"><em>${this.sol_fecha}</em>&nbsp; &nbsp; &nbsp; &nbsp;<strong>Para: </strong><em>AQUI VA EL NOMBRE DEL PROVEEDOR</em></span></p>
                                      <p style="margin: 0cm; font-size: 11pt; font-family: Calibri, sans-serif; line-height: 160%; text-align: left;"><strong><span style="font-family: Arial, sans-serif; line-height: 22.4px;">Descripción: </span></strong><em><span style="font-family: Arial, sans-serif; line-height: 22.4px;"> ${this.sol_asunto}</span></em></p>
                                    </div>
